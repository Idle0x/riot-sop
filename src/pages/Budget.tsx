...
import { formatCurrency } from '../utils/format'; // Use Safe Formatter
...
export const Budget = () => {
  ...
  const resetBudgetCycle = () => {
    // In V2, we might implement a specific mutation for this,
    // or just rely on the Monthly Checkpoint to handle it naturally.
    // For manual reset, we would need to iterate and update.
    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-8 pb-20">
      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-gray-400">Total Monthly Burn: {formatCurrency(totalMonthly)}</p>
        </div>
              ...
              <div className="flex justify-between items-center mb-2">
                <div>
                  ...
                  <div className="text-xs text-gray-500">
                     <span className="text-white">{formatCurrency(b.spent || 0)}</span> / {formatCurrency(b.amount)}
                  </div>
                </div>
                <button 
