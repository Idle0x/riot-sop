        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 animate-fade-in">
          <GlassCard className="w-full max-w-md p-6 relative">
            ...
            <div className="space-y-4">
               ...
               <GlassInput label="Amount" type="number" value={spendAmount} onChange={e => setSpendAmount(e.target.value)} autoFocus />
               <GlassInput label="Note" value={spendNote} onChange={e => setSpendNote(e.target.value)} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <GlassCard className="p-6 h-fit">
          ...
          <div className="space-y-4">
            ...
            <GlassInput label="Limit (NGN)" type="number" value={amount} onChange={e => setAmount(e.target.value)} />
