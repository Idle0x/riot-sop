            ...
            <>
                ...
                >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                          <h3 className="font-bold text-white text-lg flex items-center gap-2">
                            System Leak Detected <ArrowRight size={16} className={`text-red-400 transition-transform ${showActionCenter ? 'rotate-90' : 'opacity-0 group-hover:opacity-100'}`}/>
                          </h3>
                    ...
                    <div className="flex flex-col md:items-end gap-2">
                        <div className="text-xs text-gray-400 uppercase tracking-widest font-bold group-hover:text-red-300 transition-colors">
