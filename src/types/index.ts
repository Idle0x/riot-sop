...
// --- HISTORY (UNIVERSAL BLACKBOX ONTOLOGY) ---
export type LogType = 
  'DROP' | 'SPEND' | 'TRANSFER' | 'TRIAGE' | 'TRIAGE_SESSION' | 'TAX_ALLOCATION' | 'GENEROSITY' | 'GENEROSITY_GIFT' |
  'SIGNAL_CREATE' | 'SIGNAL_ADVANCE' | 'SIGNAL_KILL' | 'SIGNAL_REVIVE' | 'SIGNAL_UPDATE' | 'SIGNAL_HARVEST' | 'FIELD_REPORT' | 'WORK_SESSION' |
  'GOAL_CREATE' | 'GOAL_FUND' | 'GOAL_UPDATE' | 'GOAL_ACHIEVED' | 'GOAL_DELETE' | 
  'BUDGET_CREATE' | 'BUDGET_UPDATE' | 'BUDGET_DELETE' |
  'PARAM_UPDATE' | 'CONSTITUTION_AMENDMENT' | 'SYSTEM_RESET' |
  'SYSTEM_EVENT' | 'AUDIT_COMPLETED' | 'JOURNAL' | 'JOURNAL_LOGGED' | 'EMERGENCY_ACCESS';
